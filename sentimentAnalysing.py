...
def update_ytlist(ytvalue):
	global current_ytvalue
	current_ytvalue = ytvalue

client_credentials_manager = SpotifyClientCredentials(client_id=client_id, client_secret=client_secret)
sp = spotipy.Spotify(client_credentials_manager=client_credentials_manager) 
#spotify object to access API
# sentiments are from other file
#name = "{Artist Name}" #chosen artist

#dummytr.update_sentiment()
emotion=str(dummytr.current_value)
#print(emotion)
result = sp.search(emotion) #search query, pass sentiment sp.search("surprise")
